              ...
              <div className="w-full p-4 px-5 py-5">
                <div className="md:grid md:grid-cols-3 gap-2 ">
                            ...
                            <div className="flex justify-center gap-2 items-center">
                              ...
                              <div>
                                <button
                                  ...
                                  className="p-3 text-gray-500 font-medium"
                                >
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-6 w-6"
                  ...
                  <div className=" p-5 bg-white rounded overflow-visible">
                    <span className="text-xl font-medium text-gray-900 block pb-3">
                      Details
                    </span>
                    <form
                    ...
                    >
                      ...
                      <div className="pt-6">
                        <button
                          type="submit"
                          className="flex w-full items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
                          <svg
