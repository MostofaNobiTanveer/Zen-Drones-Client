...
const Signup = () => {
  ...
  const { isLoading, signUpUser, signInWithGoogle } = useAuthContext();
  ...
  return (
    <>
      <section className="grid lg:grid-cols-5 grid-cols-2 min-h-screen">
        <div className="hidden lg:flex col-span-2 bg-gradient-to-br from-blue-300 to-red-200">
