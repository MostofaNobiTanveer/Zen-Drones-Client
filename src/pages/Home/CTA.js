          ...
          <div class="bg-gradient-to-br from-purple-400 to-indigo-300 lg:col-start-3 lg:col-span-10 lg:row-span-full sm:col-start-1 sm:col-span-full col-start-1 col-span-full rounded-xl row-start-3 row-span-6 pt-24 md:pt-20 md:pb-6 lg:pt-6">
            <div class="w-full p-4 h-full flex lg:pr-12 xl:pr-0 justify-center items-center">
              <div className="flex flex-col justify-center items-center max-w-xlz lg:max-w-xl lg:ml-6 space-y-4">
                ...
                <Link
                  to="/explore-drones"
                  class="btn-secondary block w-full py-3 px-5 text-center bg-blue-50 border border-transparent rounded-md shadow-md text-base font-medium text-indigo-700 sm:inline-block sm:w-auto"
                >
                  Browse Collections
                </Link>
              </div>
