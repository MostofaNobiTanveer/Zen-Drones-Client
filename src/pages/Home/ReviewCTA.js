  ...
  return (
    <div className="pb-16">
      <div className="container px-3 mx-auto">
        <div className="max-w-5xl mx-auto grid grid-cols-12 grid-rows-12 lg:grid-rows-1">
          <div className=" z-10 lg:col-start-1 lg:col-span-4 lg:row-span-full md:col-start-4 md:col-span-6 sm:col-start-3 sm:col-span-7 col-start-2 col-span-10 row-start-1 row-span-5">
            <img
              className="w-44 sm:w-52 lg:w-full lg:max-w-xs object-cover transform -rotate-12 object-center rounded-3xl  h-full"
          ...
          <div className="bg-gradient-to-br from-purple-400 to-indigo-300 lg:col-start-3 lg:col-span-10 lg:row-span-full sm:col-start-1 sm:col-span-full col-start-1 col-span-full rounded-xl row-start-3 row-span-6 pt-24 md:pt-20 md:pb-6 lg:pt-6">
            <div className="w-full p-4 h-full flex lg:pr-12 xl:pr-0 justify-center items-center">
              <div className="flex flex-col justify-center items-center max-w-xl lg:ml-20 space-y-4">
                ...
                <Link
                  to="/reviews"
                  className="btn-secondary block w-full py-3 px-5 text-center bg-indigo-50 border border-transparent rounded-md shadow-md text-base font-medium text-indigo-700 sm:inline-block sm:w-auto"
                >
                  Browse Reviews
                </Link>
                <Link
