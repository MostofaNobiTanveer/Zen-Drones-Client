      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-8 lg:py-12 lg:px-8">
        <div className="grid lg:grid-cols-2 lg:gap-8">
          <div className="space-y-6">
            ...
            <p className="text-white text-base">
              ...
              From aerial photography and videography to inspection solutions
              and more, we have drones that are optimal for every application.
            </p>
            <div className="flex space-x-6">
              {socialLinks.map(({ name, href, pathData, id }) => {
                return (
                  <Link
                    to={{
                      pathname: `${href}`,
        ...
        <div className="mt-12 border-t border-gray-300 pt-8">
          <p className="text-base text-white xl:text-center">
            &copy; {new Date().getFullYear()} Zen Drones, Inc. All rights
            reserved.
          </p>
        </div>
      </div>
