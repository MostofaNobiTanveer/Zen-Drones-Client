...
const ProductCard = ({ id, name, img, price }) => {
  ...
  return (
    <Link
      ...
      title={name}
      className="product_card bg-woodsmoke-300 overflow-hidden relative p-6 group focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500 shadow"
    >
      ...
      <span className="pointer-events-none absolute top-4 right-6 sm:right-4 text-white">
        <svg
          className="h-6 w-6"
